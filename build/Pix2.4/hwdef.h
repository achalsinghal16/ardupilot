...
#define HAL_UARTB_DRIVER Empty::UARTDriver uartBDriver
#define HAL_UARTC_DRIVER ChibiOS::UARTDriver uartCDriver(1)
#define HAL_UARTD_DRIVER ChibiOS::UARTDriver uartDDriver(2)
...
#define HAL_UART_DEVICE_LIST HAL_OTG1_CONFIG,HAL_USART2_CONFIG,HAL_USART3_CONFIG
