...
// SPI device table
#define HAL_SPI_DEVICE0  SPIDesc("ramtron"        ,  1, 10, PAL_LINE(GPIOD,10U), SPIDEV_MODE3,   8*MHZ,   8*MHZ)
#define HAL_SPI_DEVICE1  SPIDesc("external0m0"    ,  2,  5, PAL_LINE(GPIOE,4U) , SPIDEV_MODE0,   2*MHZ,   2*MHZ)
#define HAL_SPI_DEVICE2  SPIDesc("external0m1"    ,  2,  5, PAL_LINE(GPIOE,4U) , SPIDEV_MODE1,   2*MHZ,   2*MHZ)
#define HAL_SPI_DEVICE3  SPIDesc("external0m2"    ,  2,  5, PAL_LINE(GPIOE,4U) , SPIDEV_MODE2,   2*MHZ,   2*MHZ)
#define HAL_SPI_DEVICE4  SPIDesc("external0m3"    ,  2,  5, PAL_LINE(GPIOE,4U) , SPIDEV_MODE3,   2*MHZ,   2*MHZ)
#define HAL_SPI_DEVICE5  SPIDesc("pixartPC15"     ,  2, 13, PAL_LINE(GPIOC,15U), SPIDEV_MODE3,   2*MHZ,   2*MHZ)
...
#define HAL_UART4_CONFIG { (BaseSequentialStream*) &SD4, 4, false, STM32_UART4_RX_DMA_CONFIG, STM32_UART4_TX_DMA_CONFIG, PAL_LINE(GPIOA,0U), PAL_LINE(GPIOA,1U), 0, -1, 0, -1, 0}
...
#define HAL_UART7_CONFIG { (BaseSequentialStream*) &SD7, 7, false, STM32_UART7_RX_DMA_CONFIG, STM32_UART7_TX_DMA_CONFIG, PAL_LINE(GPIOE,8U), PAL_LINE(GPIOE,7U), 0, -1, 0, -1, 0}
#define HAL_USART6_CONFIG { (BaseSequentialStream*) &SD6, 6, false, STM32_USART6_RX_DMA_CONFIG, STM32_USART6_TX_DMA_CONFIG, PAL_LINE(GPIOC,6U), PAL_LINE(GPIOC,7U), 0, -1, 0, -1, 0}
