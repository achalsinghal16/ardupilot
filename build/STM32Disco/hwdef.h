...
#define HAL_GPIO_PIN_LED_ACTIVITY         PAL_LINE(GPIOE,2U)
#define HAL_GPIO_PIN_LED_BOOTLOADER       PAL_LINE(GPIOE,3U)
...
// UART configuration
#define BOOTLOADER_DEV_LIST (BaseChannel *)&SDU1,(BaseChannel *)&SD2
// USB configuration
